<div class="animated fadeIn">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="get" action="<?=base_url("admin/transaksi_keuangan/index")?>">
                        <div class="row">
                            <div class="col-md-3">
                                <label for="nf-jenis_laporan" class=" form-control-label">Tanggal</label>
                                <input onchange="javascript:submit()" type="text" id="tanggal" name="tanggal" value="<?=$tanggal?>" class="form-control">
                            </div>
                            <!-- <div class="col-md-3">
                                <label for="nf-jenis_laporan" class=" form-control-label">Tanggal</label>
                                <input onchange="javascript:submit()" type="text" id="tanggal" name="tanggal" value="<?=$tanggal?>" class="form-control">
