            ...
            <form action="<?php echo $action; ?>" method="post">
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  ...
                  <input required type="number" class="form-control" name="jumlah_bus" id="jumlah_bus" value="<?php echo $jumlah_bus; ?>" />
                </div>
              </div>

              <div class="row">
                <div class="col-md-12 form-group">
                    Tujuan <?php echo form_error('tujuan') ?>
                    <input required type="text" class="form-control" name="tujuan" id="tujuan" placeholder="Kota" value="<?php echo $tujuan; ?>" />
                </div>
              </div>
	    
              <div class="row">
                <div class="col-md-12 form-group">
                  Detail Rute <?php echo form_error('rute') ?>
                    <input required type="text" class="form-control" name="rute" id="rute" placeholder="Maksimal 3 Rute" value="<?php echo $rute; ?>" />
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  ...
                  <input required type="text" class="form-control" name="jumlah_hari" id="jumlah_hari" value="<?php echo $jumlah_hari; ?>" />
                </div>
              </div>
