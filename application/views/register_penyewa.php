    ...
    <div class="sufee-login d-flex align-content-center flex-wrap">
        <div class="container">
            <div class="login-content">
                ...
                <h3>Register Penyewa</h3>
                <p>Silahkan isi data dibawah ini.</p>
                    <form method="post" action="<?=base_url('register_act')?>">
                        <input type="hidden" name="goto_url" id="goto_url" value="<?= null != $this->session->flashdata('goto_url') ? base_url().$this->session->flashdata('goto_url'): '' ?>">
